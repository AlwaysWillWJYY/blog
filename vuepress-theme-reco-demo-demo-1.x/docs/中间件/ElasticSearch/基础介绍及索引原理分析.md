...
![在这里插入图片描述](https://img-blog.csdnimg.cn/c4292d2b25344492a8f61628e66911e5.png)

为了提高查询的效率，减少磁盘寻道次数，将多个值作为一个数组通过连续区间存放，一次寻道读取多个数据，同时也降低树的高度。

**什么是倒排索引?**

![在这里插入图片描述](https://img-blog.csdnimg.cn/9bd469a0cac14a85b09c702138524f10.png)

继续上面的例子，假设有这么几条数据(为了简单，去掉about, interests这两个field):

![在这里插入图片描述](https://img-blog.csdnimg.cn/623fc5fae88848c0820983dbb840e3a6.png)

`Posting List`

Elasticsearch分别为每个field都建立了一个倒排索引，Kate, John, 24, Female这些叫`term`，而[1,2]就是Posting List。Posting list就是一个int的数组，存储了所有符合某个term的文档id。
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/c7d778c65d744ba19a1259a85acf6277.png)

这棵树不会包含所有的term，它包含的是term的一些前缀。通过term index可以快速地定位到term dictionary的某个offset，然后从这个位置再往后顺序查找。

![在这里插入图片描述](https://img-blog.csdnimg.cn/42c7152a34b34d8e9f9eafc9d48ea68d.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/d72d7579d59d4b92b57e1251b0699330.png)
...
"posting list不是已经只存储文档id了吗？还需要压缩？"
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/a31424bf635d4968a02d2a19a86ff918.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/e67d3428d87c4c198843cbfb0840f962.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/468d47b3225e495899f15562a32767ea.png)

将一个有序链表level0，挑出其中几个元素到level1及level2，每个level越往上，选出来的指针元素越少，查找时依次从高level往低查找，比如55，先找到level2的31，再找到level1的47，最后找到55，一共3次查找，查找效率和2叉树的效率相当，但也是用了一定的空间冗余来换取的。

假设有下面三个posting list需要联合索引：

![在这里插入图片描述](https://img-blog.csdnimg.cn/8ca9583dab304a40a79c861df2c15dcc.png)
